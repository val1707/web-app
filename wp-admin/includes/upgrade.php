	...
	function wp_install_defaults( $user_id ) {
		...
		if ( is_multisite() ) {
			...
			if ( ! $first_post ) {
				...
				__( 'Welcome to %s. This is your first post. Edit or delete it, then start writing! Sagsdgsdgdg!!!!' ) .
				"</p>\n<!-- /wp:paragraph -->";
			}
			...
			$first_post = "<!-- wp:paragraph -->\n<p>" .
			/* translators: First post content. %s: Site link. */
			__( 'Welcome to WordPress. This is your first post. Edit or delete it, then start writing! Sagsdgsdgdg' ) .
			"</p>\n<!-- /wp:paragraph -->";
		}
